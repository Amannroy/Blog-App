...
const TopBlogs = () => {
    ...
    const fetchTopNews = async () => {
        ...
        try {
            const response = await axios.get('https://newsapi.org/v2/top-headlines?sources=google-news-in&apiKey=dabb41bdfbeb488eaa812971ce14a172&q=india'); 
    ...
    return (
        <div className="container">
            ...
            <button className="fetch-button" onClick={fetchTopNews}>Watch Top News</button>
                ...
                <ul className="news-list">
                    {articles.map((article, index) => (
                        <li key={index} className="news-item">
                            ...
                            {article.publishedAt && <p>{new Date(article.publishedAt).toLocaleString()}</p>}
